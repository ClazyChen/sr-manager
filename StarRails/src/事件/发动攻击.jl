...
@创建事件 发动攻击 begin
    ...
    function 发动攻击(战场::战场; 来源::角色, 目标::角色, 威力::Int, 性质::Vector{标签.性质}=[])
        new(战场, 性质, 来源, 目标, 威力, 来源.模板.属性, 来源.攻击, 来源.暴击, 来源.穿甲, 目标.防御, 0, false, false)
    end
...
function 攻击目标!(事件::事件; 威力::Int, 来源 = 事件.来源, 目标 = 事件.目标, 额外性质::Vector = [])
    触发(发动攻击(事件.战场, 来源 = 来源, 目标 = 目标, 威力 = 威力, 性质 = [事件.性质列表..., 额外性质...]))
end
